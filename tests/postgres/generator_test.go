...
func TestCmdGeneratorWithModelJSONTags(t *testing.T) {
	caseStyles := []string{"camel-case", "pascal-case", "snake-case"}

	for _, style := range caseStyles {
		err := os.RemoveAll(genTestDir2)
		require.NoError(t, err)
		...
		assertGeneratedModelFileWithJSONTag(t, style)
...
func assertGeneratedModelFileWithJSONTag(t *testing.T, modelJSONTag string) {
	var actorModelFileWithJSONTag string

	switch modelJSONTag {
	case "snake-case":
		actorModelFileWithJSONTag = actorModelFileWithJSONTagInSnakeCase
	case "camel-case":
		actorModelFileWithJSONTag = actorModelFileWithJSONTagInCamelCase
	case "pascal-case":
		actorModelFileWithJSONTag = actorModelFileWithJSONTagInPascalCase
	}

	// Assert the generated model file with JSON tags
	testutils.AssertFileContent(t, "./.gentestdata2/jetdb/dvds/model/actor.go", actorModelFileWithJSONTag)
}
...
var actorModelFileWithJSONTagInSnakeCase = `
//
// Code generated by go-jet DO NOT EDIT.
//
// WARNING: Changes to this file may cause incorrect behavior
...
type Actor struct {
	ActorID    int32     ` + "`sql:\"primary_key\" json:\"actor_id\"`" + `
...
var actorModelFileWithJSONTagInCamelCase = `
//
// Code generated by go-jet DO NOT EDIT.
//
// WARNING: Changes to this file may cause incorrect behavior
...
type Actor struct {
	ActorID    int32     ` + "`sql:\"primary_key\" json:\"actorID\"`" + `
...
var actorModelFileWithJSONTagInPascalCase = `
//
// Code generated by go-jet DO NOT EDIT.
//
// WARNING: Changes to this file may cause incorrect behavior
